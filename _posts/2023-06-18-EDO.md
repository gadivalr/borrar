...
&=\frac{1}{\pi}\int_{-\pi}^{0}0dt+\frac{1}{\pi}\int_{0}^{\pi}1dt\\
&=\frac{1}{\pi}\int_{0}^{\pi}1dt\\
&=\frac{1}{\pi}t\Big|_{0}^{\pi}\\
&=\frac{1}{\pi}(\pi-0)\\
a_0&=1\\
a_n&=\frac{1}{\pi}\int_{-\pi}^{\pi}f(t)cos(nt)dt\\
&=\frac{1}{\pi}\int_{-\pi}^{0}0cos(nt)dt+\frac{1}{\pi}\int_{0}^{\pi}1cos(nt)dt\\
&=\frac{1}{\pi}\int_{0}^{\pi}cos(nt)dt\\
&=\frac{1}{\pi}\frac{sen(nt)}{n}\Big|_{0}^{\pi}\\
&=\frac{1}{\pi}\frac{sen(n\pi)}{n}-\frac{1}{\pi}\frac{sen(0)}{n}\\
&=\frac{1}{\pi}\frac{sen(n\pi)}{n}\\
&=\frac{1}{\pi}\frac{0}{n}\\
a_n&=0\\
b_n&=\frac{1}{\pi}\int_{-\pi}^{\pi}f(t)sen(nt)dt\\
&=\frac{1}{\pi}\int_{-\pi}^{0}0sen(nt)dt+\frac{1}{\pi}\int_{0}^{\pi}1sen(nt)dt\\
&=\frac{1}{\pi}\int_{0}^{\pi}sen(nt)dt\\
&=\frac{1}{\pi}\frac{-cos(nt)}{n}\Big|_{0}^{\pi}\\
&=\frac{1}{\pi}\frac{-cos(n\pi)}{n}+\frac{1}{\pi}\frac{cos(0)}{n}\\
&=\frac{1}{\pi}\frac{-cos(n\pi)}{n}+\frac{1}{\pi}\frac{1}{n}\\
